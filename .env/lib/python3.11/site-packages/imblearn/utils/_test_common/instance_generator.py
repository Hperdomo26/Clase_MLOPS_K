...
INIT_PARAMS = {
    # estimator
    BalancedBaggingClassifier: dict(random_state=45),
    BalancedRandomForestClassifier: dict(random_state=45),
    EasyEnsembleClassifier: [
        # AdaBoostClassifier does not allow nan values
        dict(random_state=45),
        # DecisionTreeClassifier allows nan values
        dict(estimator=DecisionTreeClassifier(random_state=45), random_state=45),
    ],
    Pipeline: dict(
        steps=[
    ...
    # over-sampling
    ADASYN: dict(random_state=45),
    BorderlineSMOTE: dict(random_state=45),
    KMeansSMOTE: dict(random_state=0),
    RandomOverSampler: dict(random_state=45),
    SMOTE: dict(random_state=45),
    SMOTEN: dict(random_state=45),
    SMOTENC: dict(categorical_features=[0], random_state=45),
    SVMSMOTE: dict(random_state=45),
    # under-sampling
    ClusterCentroids: dict(random_state=45),
    CondensedNearestNeighbour: dict(random_state=45),
    InstanceHardnessThreshold: dict(random_state=45),
    NearMiss: [dict(version=1), dict(version=2), dict(version=3)],
    OneSidedSelection: dict(random_state=45),
    RandomUnderSampler: dict(random_state=45),
    # combination
    SMOTEENN: dict(random_state=45),
    SMOTETomek: dict(random_state=45),
}
