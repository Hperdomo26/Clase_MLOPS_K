...
class TestTransformedDensityRejection:
    ...
    def test_basic(self, dist, mv_ex):
        with suppress_warnings() as sup:
            ...
            rng = TransformedDensityRejection(dist, random_state=45)
...
class TestDiscreteAliasUrn:
    ...
    def test_basic(self, distname, params):
        ...
        pv = dist.pmf(k)
        mv_ex = dist.stats('mv')
        rng = DiscreteAliasUrn(dist, random_state=45)
    ...
    def test_gh19359(self):
        ...
        rng = DiscreteAliasUrn(pv, random_state=45)
...
class TestNumericalInversePolynomial:
    ...
    @pytest.mark.parametrize("dist, mv_ex",
                             zip(dists, mvs))
    def test_basic(self, dist, mv_ex):
        rng = NumericalInversePolynomial(dist, random_state=45)
        check_cont_samples(rng, dist, mv_ex)
...
class TestNumericalInverseHermite:
    ...
    def test_basic(self, dist, mv_ex, order):
        rng = NumericalInverseHermite(dist, order=order, random_state=45)
        check_cont_samples(rng, dist, mv_ex)
...
class TestDiscreteGuideTable:
    ...
    def test_basic(self, distname, params):
        ...
        pv = dist.pmf(k)
        mv_ex = dist.stats('mv')
        rng = DiscreteGuideTable(dist, random_state=45)
        check_discr_samples(rng, pv, mv_ex)
...
class TestSimpleRatioUniforms:
    ...
    @pytest.mark.parametrize("dist, mv_ex",
                             zip(dists, mvs))
    def test_basic(self, dist, mv_ex):
        rng = SimpleRatioUniforms(dist, mode=dist.mode, random_state=45)
        check_cont_samples(rng, dist, mv_ex)
